#!/bin/bash
#Generated on 2023-03-14 10:59:43 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=f36cbefe-430d-477d-9e43-1ed6839be720&pack=zh-cn&edition=core&aria2=2"
if [ $? != 0 ]; then
