#!/bin/bash
#Generated on 2023-03-14 15:59:42 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=fcd8b9e8-d093-465a-bf2d-ae5e547de015&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
